<!-- memahami konsep sesion dari halaman1 dan halaman2 -->
<?php 
// $nama = "Erik Lewis";
// echo $nama
session_start();

$_SESSION["nama"] = "Erik Lewis Simaremare"; 
...
problem3. kita juga bisa menghilangkan sessionnya tanpa menutup browsernya caranya menggunakan session_destroy(); di halaman3
-->
